...
require (
	...
	github.com/GoogleCloudPlatform/opentelemetry-operations-go/exporter/metric v0.46.0 // indirect
	...
	github.com/envoyproxy/protoc-gen-validate v1.2.2-SNAPSHOT.0 // indirect
